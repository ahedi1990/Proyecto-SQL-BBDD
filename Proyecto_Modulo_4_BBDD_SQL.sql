...
select "title" as "Título", COUNT(*) as "Cantidad_disponible"
from "film" as f
inner join "inventory" as i
on f."film_id" = i."film_id"
group by "title" 
having COUNT(f."film_id") = count(i."film_id");
...
--Si, porque puedes ver las dos tablas de un solo vistazo.
...
on r.inventory_id = i.inventory_id
inner join "customer" as c
on c.customer_id = i.inventory_id
